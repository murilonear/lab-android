...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            // Lista
            listaDeTarefas = findViewById(R.id.listViewId);
    ...
    private void recuperarTarefas() {
        try {
            ...
            cursor.moveToFirst();
            while (cursor != null) {
             /*   Log.i("Resultado -", "Id Tarefa: " + cursor.getString(indiceColunaId) + "Tarefa: "
    ...
    private void removerTarefa(Integer id) {
        try {
            ...
            recuperarTarefas();
            Toast.makeText(getApplicationContext(), "Tarefa removida com sucesso!", Toast.LENGTH_SHORT)
                    .show();
        } catch (Exception e) {
            e.printStackTrace();
        }
